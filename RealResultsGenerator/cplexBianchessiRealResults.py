...
def cplexBianchessiRealResults(basePath, dataFolder, googleMapsApiKey):
    tripsJson = 0
    with open(basePath + '\\BianchessiResult.json') as data_file:    
    ...
    plotly.offline.plot(fig, filename=basePath + '\\BianchessiRealDataGant.html')