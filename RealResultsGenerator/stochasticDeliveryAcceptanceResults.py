...
def stochasticDeliveryAcceptanceResults(basePath, dataFolder, googleMapsApiKey, deliveries, loadingPlaces, fileName):
    tripsJson = 0
    ...
    plotly.offline.plot(fig, filename=basePath + fileName + 'Gant_' + dataFolder + '.html')
